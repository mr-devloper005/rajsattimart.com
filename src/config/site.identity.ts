export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'rajsattimart',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Raj Satti Mart',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'rajsattimart.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://rajsattimart.com',
